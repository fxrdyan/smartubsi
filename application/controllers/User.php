...
$data['join'] = $this->ModelUser->joinMahasiswaProdi('user','prodi','user.id_prodi=prodi.id')->result_array();
...
$data['user'] = $this->ModelUser->cekData(['email' => $this->session->userdata('email')])->row_array();
$data['mahasiswa'] = $this->ModelMahasiswa->getMahasiswa()->result_array();
